...
プラグインは新しいツールと機能でClaude Codeを拡張する。このガイドはインストールのみをカバーしている - いつ、なぜ使用するかについては [記事全文](https://x.com/affaanmustafa/status/2012378465664745795) を参照のこと。
