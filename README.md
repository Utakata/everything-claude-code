...
**That's it!** You now have access to 57 agents, 183 skills, and 89 legacy command shims.
...
|---------|-------------|----------|--------|
| Agents | PASS: 57 agents | PASS: 12 agents | **Claude Code leads** |
| Commands | PASS: 89 commands | PASS: 31 commands | **Claude Code leads** |
...
|---------|------------|------------|-----------|----------|
| **Agents** | 57 | Shared (AGENTS.md) | Shared (AGENTS.md) | 12 |
| **Commands** | 89 | Shared | Instruction-based | 31 |
